...
The denominator of  \autoref{eq:modelZdivided} factorises so we may write for the origin balancing factors $bf_{i}$
...
print(knitr::kable(seedAry, row.names = TRUE, col.names= rownames(costData),caption = "Deterence function"))
```
...
This gives the factorisation as sought in equation \autoref{eq:modelZdivided}.
